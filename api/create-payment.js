...
const PLANS = {
  '1H': { usd: 0.1,  seconds: 3600,     label: '1 Hour' },
  '1D': { usd: 1,  seconds: 86400,    label: '1 Day' },
  '1W': { usd: 3,  seconds: 604800,   label: '1 Week' },
  '1M': { usd: 6, seconds: 2592000,  label: '1 Month' },
  'LT': { usd: 12, seconds: null,     label: 'Lifetime' },
};
